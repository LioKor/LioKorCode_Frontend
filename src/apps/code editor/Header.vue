...
<template>
  <div class="header header-editor">
    <div class="topLine">
      ...
      <div v-show="!redactorSessionUid" @click="openSession">Совместное редактирование</div>
      ...
      <router-link v-if="$store.state.user.isLogined" to="/profile" class="right profile-button">
